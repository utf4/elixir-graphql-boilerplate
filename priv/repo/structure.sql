...
ALTER TABLE ONLY public.posts
    ADD CONSTRAINT posts_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.user_accounts(id) ON DELETE CASCADE;
...
INSERT INTO public."schema_migrations" (version) VALUES (20220428084035);
